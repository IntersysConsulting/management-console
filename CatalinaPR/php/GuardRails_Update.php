...
foreach($decodedata as $mydata)
    ...
    {
         echo $mydata->metric_id_val . "\n";
        $result = mysql_query("UPDATE pr_guard_rails SET ".$mydata->col_nam."='".$mydata->col_value."',update_date='".$today."' WHERE  user_id='".$mydata->user_id_val."'  AND metric_id='".$mydata->metric_id_val."'  ",$db_connect) or die ('Unable to update row.');
    }
