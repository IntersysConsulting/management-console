...
foreach ($decodedata as $data) {
    ...
    $result = mysqli_query($con, "UPDATE pr_guard_rails SET " . $data->col_nam . "='" . $data->col_value . "',update_date='" . $today . "' WHERE  user_id='" . $data->user_id_val . "'  AND metric_id='" . $data->metric_id_val . "'  ") or die('Unable to update row.');
}
?>
