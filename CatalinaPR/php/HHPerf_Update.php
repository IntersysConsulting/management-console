...
foreach($decodedata as $data)

    {
        ...
        $result = mysqli_query($con, "UPDATE pr_hh_perform SET ".$data->col_nam."='".$data->col_value."',update_date='".$today."' WHERE  user_id='".$data->user_id_val."'  AND index_id='".$data->ind_id_val."'  ") or die ('Unable to update row.');
    }
