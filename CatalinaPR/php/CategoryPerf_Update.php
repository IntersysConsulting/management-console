...
foreach($decodedata as $mydata)
    ...
    {
         echo $mydata->ind_id_val . "\n";
        $result = mysql_query("UPDATE pr_category_perf SET ".$mydata->col_nam."='".$mydata->col_value."',update_date='".$today."' WHERE  user_id='".$mydata->user_id_val."'  AND index_id='".$mydata->ind_id_val."'  ",$db_connect) or die ('Unable to update row.');
    }
