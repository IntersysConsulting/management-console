...
foreach($decodedata as $data)

    {
        ...
        $result = mysqli_query($con, "UPDATE pr_roi_goals SET ".$data->col_nam."='".$data->col_value."',update_date='".$today."' WHERE  user_id='".$data->user_id_val."'  AND segment_id='".$data->seg_id_val."'  ") or die ('Unable to update row.');
    }
