...
foreach($decodedata as $mydata)
    ...
    {
         echo $mydata->seg_id_val . "\n";
        $result = mysql_query("UPDATE pr_purch_cycle_adj SET ".$mydata->col_nam."='".$mydata->col_value."',update_date='".$today."' WHERE  user_id='".$mydata->user_id_val."'  AND segment_id='".$mydata->seg_id_val."'  ",$db_connect) or die ('Unable to update row.');
    }
