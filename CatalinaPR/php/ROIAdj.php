...
<!--        <form action="ROIAdj_Update.php" method="POST" id="update" style="margin-left: 75px;">
            <div>-->
                ...
                <table style="margin-left:80px; width:460px;">
                    <?php while ($row = mysql_fetch_array($results)) { ?>
                        <tr style=" float:left; height:18px" class="sales_change_row">
                            ...
                            <td style="width:45px;"><input name="roi_adj['<?php echo $i ?>']"  id="n5_val" class="inpu_text" style="width:44px; font-size: 10px;"  value="<?php echo number_format($row[1], 2, '.', ''); ?>"/></td>
                            <td style="width:45px;"><input name="roi_adj['<?php echo $i ?>']"  id="n4_val" class="inpu_text"  style="width:44px;"   value="<?php echo number_format($row[2], 2, '.', ''); ?>"/></td>
                            <td style="width:45px;"><input name="roi_adj['<?php echo $i ?>']"  id="n3_val" class="inpu_text"  style="width:44px;" value="<?php echo number_format($row[3], 2, '.', ''); ?>"/></td>
                            <td style="width:45px;"><input name="roi_adj['<?php echo $i ?>']"  id="n2_val" class="inpu_text"  style="width:44px;" value="<?php echo number_format($row[4], 2, '.', ''); ?>"/></td>
                            <td style="width:45px;"><input name="roi_adj['<?php echo $i ?>']"  id="n1_val" class="inpu_text"  style="width:44px;" value="<?php echo number_format($row[5], 2, '.', ''); ?>"/></td>
                            <td style="width:45px;"><input name="roi_adj['<?php echo $i ?>']"  id="zed_val" class="inpu_text"  style="width:44px;" value="<?php echo number_format($row[6], 2, '.', ''); ?>"/></td>
                            <td style="width:45px;"><input name="roi_adj['<?php echo $i ?>']"  id="p5_val" class="inpu_text"  style="width:44px;" value="<?php echo number_format($row[7], 2, '.', ''); ?>"/></td>
                            <td style="width:45px;"><input name="roi_adj['<?php echo $i ?>']"  id="p4_val" class="inpu_text"  style="width:44px;" value="<?php echo number_format($row[8], 2, '.', ''); ?>"/></td>
                            <td style="width:45px;"><input name="roi_adj['<?php echo $i ?>']"  id="p3_val" class="inpu_text"  style="width:44px;" value="<?php echo number_format($row[9], 2, '.', ''); ?>"/></td>
                            <td style="width:45px;"><input name="roi_adj['<?php echo $i ?>']" id="p2_val" class="inpu_text"  style="width:44px;" value="<?php echo number_format($row[10], 2, '.', ''); ?>"/></td>
                            <td style="width:45px;"><input name="roi_adj['<?php echo $i ?>']" id="p1_val" class="inpu_text"  style="width:44px;" value="<?php echo number_format($row[11], 2, '.', ''); ?>"/></td>
                            <td style="width:45px;"><input type="hidden" id="row_num" value="<?php echo $i ?>"/></td>
                        </tr>
