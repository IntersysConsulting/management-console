...
//    echo $data->metric_id_val . "\n";
    $result = mysql_query("UPDATE pr_program_param SET " . $data->col_nam . "='" . $data->col_value . "',update_date='" . $today . "' WHERE  user_id='" . $data->user_id_val . "'  AND p_parameter_id='" . $data->metric_id_val . "'  ", $con) or die('Unable to update row.');
}
?>
