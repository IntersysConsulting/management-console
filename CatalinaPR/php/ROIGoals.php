...
<div class="controls" id="chartarea">
     <div style="margin-left:20px; margin-top:20px;">
        <div class="heading" style="margin-left: 147px;width: 450px;">
        ...
        <div>
            <div class="segment" style="width: 137px;height: 18px;">Segment</div>
            <div class="headers" style="margin-left: 147px;width: 450px;">
...
<!--        <form action="ROIGoals_Update.php" method="POST" id="update">
            <div>-->
                ...
                <?php while ($row = mysql_fetch_array($results)) { ?>
                        <tr style=" height:10px" class="roi_goals_row">
                            ...
                            <td style="width:36px;"><input name="roi_goals['<?php echo $i ?>']"  id="n5_val" class="inpu_text" style="width:41px; font-size: 10px;"  value="<?php echo number_format($row[3], 2, '.', ''); ?>"/></td>
                            <td style="width:36px;"><input name="roi_goals['<?php echo $i ?>']"  id="n4_val" class="inpu_text"  style="width:41px;"   value="<?php echo number_format($row[4], 2, '.', ''); ?>"/></td>
                            <td style="width:36px;"><input name="roi_goals['<?php echo $i ?>']"  id="n3_val" class="inpu_text"  style="width:41px;" value="<?php echo number_format($row[5], 2, '.', ''); ?>"/></td>
                            <td style="width:36px;"><input name="roi_goals['<?php echo $i ?>']"  id="n2_val" class="inpu_text"  style="width:41px;" value="<?php echo number_format($row[6], 2, '.', ''); ?>"/></td>
                            <td style="width:36px;"><input name="roi_goals['<?php echo $i ?>']"  id="n1_val" class="inpu_text"  style="width:41px;" value="<?php echo number_format($row[7], 2, '.', ''); ?>"/></td>
                            <td style="width:36px;"><input name="roi_goals['<?php echo $i ?>']"  id="zed_val" class="inpu_text"  style="width:41px;" value="<?php echo number_format($row[8], 2, '.', ''); ?>"/></td>
                            <td style="width:36px;"><input name="roi_goals['<?php echo $i ?>']"  id="p5_val" class="inpu_text"  style="width:41px;" value="<?php echo number_format($row[9], 2, '.', ''); ?>"/></td>
                            <td style="width:36px;"><input name="roi_goals['<?php echo $i ?>']"  id="p4_val" class="inpu_text"  style="width:41px;" value="<?php echo number_format($row[10], 2, '.', ''); ?>"/></td>
                            <td style="width:36px;"><input name="roi_goals['<?php echo $i ?>']"  id="p3_val" class="inpu_text"  style="width:41px;" value="<?php echo number_format($row[11], 2, '.', ''); ?>"/></td>
                            <td style="width:36px;"><input name="roi_goals['<?php echo $i ?>']" id="p2_val" class="inpu_text"  style="width:41px;" value="<?php echo number_format($row[12], 2, '.', ''); ?>"/></td>
                            <td style="width:36px;"><input name="roi_goals['<?php echo $i ?>']" id="p1_val" class="inpu_text"  style="width:41px;" value="<?php echo number_format($row[13], 2, '.', ''); ?>"/></td>
