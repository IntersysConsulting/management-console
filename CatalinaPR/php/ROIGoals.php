...
<div class="controls" id="chartarea">
        <div class="heading">
            ...
            <div style="text-align: center;">Monthly Segment Change-Recovery, Frequency, Monetary Value</div>
        </div>
        ...
        <form action="ROIGoals_Update.php" method="POST" id="update">
            <div>
                ...
                $query = "SELECT a.user_id,a.segment_id,b.segment_desc, a.n5_val, a.n4_val, a.n3_val, a.n2_val, a.n1_val, a.zed_val, a.p5_val, a.p4_val, a.p3_val, a.p2_val, a.p1_val FROM pr_roi_goals a INNER JOIN pr_segment b ON a.segment_id = b.segment_id  AND a.user_id ='app'";
...
<td style="width:0px;"><input id="user_id" type="hidden" name="user_id" value="" /></td>
<td style="width:0px;"><input id="segment_id" type="hidden" name="segment_id" value="" /></td>
<td style="">&nbsp;</td>
...
<tbody>
                <?php while ($row = mysqli_fetch_array($results)) { ?>
                        <tr style=" height:8px" class="roi_goals_row">
                            ...
                            <td class="segmentdesc" style="width:150px"><?php echo $row[2]; ?></td>
		    ...
		    <div style="display:inline-block;width:50px;margin:15px;"><input style="padding-right:15px;font-size:13px;padding-left:15px;font-weight:600;" type="button" class="btn" name="save" id="ROI_Goals_save" value="Save"/></div>
                    <div style="display:inline-block;width:50px;"><input style="font-weight:600;font-size: 13px;" type="button" class="btn" name="cancel" id="roi_goals_cancel" value="Cancel"/></div>
