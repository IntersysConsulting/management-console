...
//         echo $data->metric_id_val . "\n";
    $result = mysqli_query("UPDATE pr_val_control_rule SET " . $data->col_nam . "='" . $data->col_value . "',update_date='" . $today . "' WHERE  user_id='" . $data->user_id_val . "'  AND metric_id='" . $data->metric_id_val . "'  ", $con) or die('Unable to update row.');
}
?>
