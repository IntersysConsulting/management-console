...
<div id="logout" >
 ...
 <div style="text-decoration: none;font-size:10px;color:#BACBEB; font-weight:bolder;margin-top:24px;position:absolute;margin-left:160px;"><a>Personalized Rewards</a></div>
            ...
            <div style="text-align: center;">Quintile Change-current Period vs Previous Period or same period Last Year</div>
                       ...
                       <form action="SalesChange_Update.php" method="POST" id="update"> 
                            <div>
                                ...
                                $query = "SELECT a.user_id,a.segment_id,b.segment_desc, a.n5_val, a.n4_val, a.n3_val, a.n2_val, a.n1_val, a.zed_val, a.p5_val, a.p4_val, a.p3_val, a.p2_val, a.p1_val FROM pr_sales_change a INNER JOIN pr_segment b ON a.segment_id = b.segment_id  AND a.user_id ='app'";
