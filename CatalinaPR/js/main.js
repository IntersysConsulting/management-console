...
//    include(server + 'js/jquery.validate.js', function() {
  //      include(server + 'js/jquery-ui.js', function() {
			...
			var sales_each=0,sales_range=0,not_range_sales=0;
					...
					if((typeof data == 'string' || data instanceof String)&& data.length>4) {
                                            $('#updating').html(data);
                                            $('#updating').show();
                                        }
                          ...
                          if(k==0){  var r=confirm('Are you sure you want to update this value?');}
                            if(r==true){ 
                                jQuery.ajax({
                                    ...
                                    success: function(data){
					if((typeof data == 'string' || data instanceof String) && data.length>2) {
				  ...
				  if(this.value<=parseInt(maxval1)){
                                ...
                                if((this.value>=(30))&&(this.value<=(120))&&(this.value!=""))
                                {
                                    ...
                                    GuardRails_Checking(value,column,user_val,metric_id_value);
                                      ...
                                      $(this).css("background-color","yellow");
                                    $('#guard_rails_err').html('Minimum value exceeds maximum value for Program Duration(Nonseasonal Category)');
                                    $('#guard_rails_err').show();
                                    f=false;
                                    return false;  
                                    }
				...
				/*if((metric_id_value=='1')&&(column=='minimum')){
				   maxval0=document.getElementsByName("val_con['1']")[1].value;
				      ...
				      if(value>=parseInt(minval0)){
                                ...
                                if((metric_id_value=='1')&&(column=='minimum'))
                                {
				    maxval1=document.getElementsByName("val_con['1']")[1].value;
				      ...
				      if(value<=parseInt(maxval1)){
                                ...
                                {
                                    minval1=document.getElementsByName("val_con['1']")[0].value;
                                    if((value>=(10))&&(value<=(120))&&(value!=""))
                                    {
				     if(value>=parseInt(minval1)){
                                ...
                                {
				    maxval2=document.getElementsByName("val_con['2']")[1].value;
					...
					if(value<=parseInt(maxval2)){
                                ...
                                {
                                    minval2=document.getElementsByName("val_con['2']")[0].value;
                                    if((value>=(1))&&(value<=(30))&&(value!=""))
                                    {
					if(value>=parseInt(minval2)){
                                ...
                                {
				    maxval3=document.getElementsByName("val_con['3']")[1].value;
			               ...
			               if(value<=parseInt(maxval3)){
                                ...
                                {
                                    minval3=document.getElementsByName("val_con['3']")[0].value;
                                    if((value>=(30))&&(value<=(100))&&(value!=""))
                                    {
				      if(value>=parseInt(minval3)){
                                ...
                                {
				    maxval4=document.getElementsByName("val_con['4']")[1].value;
				     ...
				     if(value<=parseInt(maxval4)){
                                ...
                                {
                                    minval4=document.getElementsByName("val_con['4']")[0].value;
                                    if((value>=(5))&&(value<=(120))&&(value!=""))
                                    {
					if(value>=parseInt(minval4)){
                                ...
                                {
				    maxval5=document.getElementsByName("val_con['5']")[1].value;
				      ...
				      if(value<=parseInt(maxval5)){
                                ...
                                {
                                    minval5=document.getElementsByName("val_con['5']")[0].value;
                                    if((value>=(30))&&(value<=(120))&&(value!=""))
                                    {
				      if(value>=parseInt(minval5)){
                                ...
                                {
				  maxval6=document.getElementsByName("val_con['6']")[1].value;
				      ...
				      if(value<=parseInt(maxval6)){
                                ...
                                {
                                    minval6=document.getElementsByName("val_con['6']")[0].value;
                                    if((value>=(30))&&(value<=(50))&&(value!=""))
                                    {
				      if(value>=parseInt(minval6)){
                                ...
                                {
				    maxval7=document.getElementsByName("val_con['7']")[1].value;
				      ...
				      if(value<=parseInt(maxval7)){
                                ...
                                {
                                    minval7=document.getElementsByName("val_con['7']")[0].value;
                                    if((value>=(5))&&(value<=(100))&&(value!=""))
                                    {
			...
			var control_each=0,control_range=0,not_range_control=0; 
                        ...
                        /*    if((metric_id_value=='1')&&(this.value>=(0))&&(this.value<=(120))&&(this.value!="")){
                             ...
                             if((metric_id_value=='1') &&(column=='minimum')&&(values>=(10))&&(values<=(120))&&(values!="")&&(values<=parseInt(maxval1)))
                            {
                                control_range++;
                            }
                            else if((metric_id_value=='1') &&(column=='maximum')&&(values>=(10))&&(values<=(120))&&(values!="")&&(values>=parseInt(minval1)))
                            {
                                control_range++;
                            }
                            else if((metric_id_value=='2')&&(column=='minimum')&& (values>=(1))&&(values<=(30))&&(values!="")&&(values<=parseInt(maxval2)))
                            {
                                control_range++;
                            }
                            else if((metric_id_value=='2')&&(column=='maximum')&& (values>=(1))&&(values<=(30))&&(values!="")&&(values>=parseInt(minval2)))
                            {
                                control_range++;
                            }
                            else if((metric_id_value=='3')&&(column=='minimum')&& (values>=(30))&&(values<=(100))&&(values!="")&&(values<=parseInt(maxval3)))
                            {
                               control_range++; 
                            }
                            else if((metric_id_value=='3')&&(column=='maximum')&& (values>=(30))&&(values<=(100))&&(values!="")&&(values>=parseInt(minval3)))
                            {
                               control_range++; 
                            }
                            else if((metric_id_value=='4')&&(column=='minimum')&& (values>=(5))&&(values<=(120))&&(values!="")&&(values<=parseInt(maxval4)))
                            {
                               control_range++; 
                            }
                            else if((metric_id_value=='4')&&(column=='maximum')&& (values>=(5))&&(values<=(120))&&(values!="")&&(values>=parseInt(minval4)))
                            {
                               control_range++; 
                            }
                            else if((metric_id_value=='5')&&(column=='minimum')&& (values>=(30))&&(values<=(120))&&(values!="")&&(values<=parseInt(maxval5)))
                            {
                               control_range++; 
                            }
                            else if((metric_id_value=='5')&&(column=='maximum')&& (values>=(30))&&(values<=(120))&&(values!="")&&(values>=parseInt(minval5)))
                            { 
                               control_range++; 
                            }
                            else if((metric_id_value=='6')&&(column=='minimum')&& (values>=(30))&&(values<=(50))&&(values!="")&&(values<=parseInt(maxval6)))
                            {
                               control_range++; 
                            }
                            else if((metric_id_value=='6')&&(column=='maximum')&& (values>=(30))&&(values<=(50))&&(values!="")&&(values>=parseInt(minval6)))
                            {
                               control_range++; 
                            }
                            else if((metric_id_value=='7')&&(column=='minimum')&& (values>=(5))&&(values<=(100))&&(values!="")&&(values<=parseInt(maxval7)))
                            {
                               control_range++; 
                            }
                            else if((metric_id_value=='7')&&(column=='maximum')&& (values>=(5))&&(values<=(100))&&(values!="")&&(values>=parseInt(minval7)))
                            {
                               control_range++; 
                            }
                    ...
                    .focus(function() {
                        ...
                        if ($.data(this, 'edited')) {
                                ...
                                else if((parameter=='9'))
                                {
                                    ...
                                    {
                                        $(this).css("background-color","yellow");
                                        $('#pgm_param_err').html('Please enter a value between 10 to 50');
                                        $('#pgm_param_err').show();
                                        f=false;
                                        return false;
                                    }
                                    ...
                                    {
                                        $(this).css("background-color","red");
                                        $('#pgm_param_err').html('Please Enter Value between 10 to 50 ');
                                        $('#pgm_param_err').show();
                                        return false;
                                    } 
                                }
		   ...
		   $('#drp_dwn_5').change(function(e) {
			...
			cnt++;	
                        ...
                        $.post(server+'php/EligibleProduct.php?l5_cat='+val, {
                            "l5_cat": val
                        }, function (txt) {  
                            $('#samples').html(txt);
			    if(cnt==1 && l4_cnt==0){
			    ...
			    $('#samples #bottomstripe').hide();
                            ...
                            $('.prod_cat_updating').hide();
                            $('#samples #pro_cat_save').hide();
                            //$('#update #samples #prod_cat_ancel').show();
			    $('#pro_cat_save').hide();
                            $('#prod_cat_err').hide();
                                  
                        });
			$('#upadte #prod_cat_ancel').hide();
                    });
