...
sSortableNone:"sorting_disabled",sSortColumn:"sorting_",sSortJUIAsc:"",sSortJUIDesc:"",sSortJUI:"",sSortJUIAscAllowed:"",sSortJUIDescAllowed:"",sSortJUIWrapper:"",sSortIcon:"",sScrollWrapper:"dataTables_scroll",sScrollHead:"dataTables_scrollHead",sScrollHeadInner:"dataTables_scrollHeadInner",sScrollBody:"dataTables_scrollBody",sScrollFoot:"dataTables_scrollFoot",sScrollFootInner:"dataTables_scrollFootInner",sFooterTH:""};n.oJUIClasses={sPagePrevEnabled:"fg-button ui-button HPSSui-state-default HPSSui-corner-left",
sPagePrevDisabled:"fg-button ui-button HPSSui-state-default HPSSui-corner-left HPSSui-state-disabled",sPageNextEnabled:"fg-button ui-button HPSSui-state-default HPSSui-corner-right",sPageNextDisabled:"fg-button ui-button HPSSui-state-default HPSSui-corner-right HPSSui-state-disabled",sPageJUINext:"HPSSui-icon HPSSui-icon-circle-arrow-e",sPageJUIPrev:"HPSSui-icon HPSSui-icon-circle-arrow-w",sPageButton:"fg-button ui-button HPSSui-state-default",sPageButtonActive:"fg-button ui-button HPSSui-state-default HPSSui-state-disabled",sPageButtonStaticDisabled:"fg-button ui-button HPSSui-state-default HPSSui-state-disabled",
sPageFirst:"first HPSSui-corner-tl HPSSui-corner-bl",sPagePrevious:"previous",sPageNext:"next",sPageLast:"last HPSSui-corner-tr HPSSui-corner-br",sStripeOdd:"odd",sStripeEven:"even",sRowEmpty:"dataTables_empty",sWrapper:"dataTables_wrapper",sFilter:"dataTables_filter",sInfo:"dataTables_info",sPaging:"dataTables_paginate fg-buttonset ui-buttonset fg-buttonset-multi ui-buttonset-multi paging_",sLength:"dataTables_length",sProcessing:"dataTables_processing",sSortAsc:"HPSSui-state-default",sSortDesc:"HPSSui-state-default",sSortable:"HPSSui-state-default",
sSortableAsc:"HPSSui-state-default",sSortableDesc:"HPSSui-state-default",sSortableNone:"HPSSui-state-default",sSortColumn:"sorting_",sSortJUIAsc:"css_right HPSSui-icon HPSSui-icon-triangle-1-n",sSortJUIDesc:"css_right HPSSui-icon HPSSui-icon-triangle-1-s",sSortJUI:"css_right HPSSui-icon HPSSui-icon-carat-2-n-s",sSortJUIAscAllowed:"css_right HPSSui-icon HPSSui-icon-carat-1-n",sSortJUIDescAllowed:"css_right HPSSui-icon HPSSui-icon-carat-1-s",sSortJUIWrapper:"DataTables_sort_wrapper",sSortIcon:"DataTables_sort_icon",sScrollWrapper:"dataTables_scroll",
sScrollHead:"dataTables_scrollHead HPSSui-state-default",sScrollHeadInner:"dataTables_scrollHeadInner",sScrollBody:"dataTables_scrollBody",sScrollFoot:"dataTables_scrollFoot HPSSui-state-default",sScrollFootInner:"dataTables_scrollFootInner",sFooterTH:"HPSSui-state-default"};n.oPagination={two_button:{fnInit:function(g,l,s){var t,w,y;if(g.bJUI){t=p.createElement("a");w=p.createElement("a");y=p.createElement("span");y.className=g.oClasses.sPageJUINext;w.appendChild(y);y=p.createElement("span");y.className=g.oClasses.sPageJUIPrev;
...
"<"){j=p.createElement("div");k=d[r+1];if(k=="'"||k=='"'){m="";for(u=2;d[r+u]!=k;){m+=d[r+u];u++}if(m=="H")m="fg-toolbar ui-toolbar HPSSui-widget-header HPSSui-corner-tl HPSSui-corner-tr HPSSui-helper-clearfix";else if(m=="F")m="fg-toolbar ui-toolbar HPSSui-widget-header HPSSui-corner-bl HPSSui-corner-br HPSSui-helper-clearfix";if(m.indexOf(".")!=-1){k=m.split(".");j.setAttribute("id",k[0].substr(1,k[0].length-1));j.className=k[1]}else if(m.charAt(0)=="#")j.setAttribute("id",m.substr(1,m.length-1));else j.className=m;r+=u}c.appendChild(j);
